...
<head>
  ...
  <!-- Favicons -->
  <link href="{{ asset('templates/web/img/favicon.png') }}" rel="icon">
  <link href="{{ asset('templates/web/img/apple-touch-icon.png') }}" rel="apple-touch-icon">
  ...
  <link href="{{ asset('templates/web/vendor/aos/aos.css') }}" rel="stylesheet">
  ...
  <link href="{{ asset('templates/web/css/main.css') }}" rel="stylesheet">
</head>
...
<body>
  ...
  <script src="{{ asset('templates/web/vendor/aos/aos.js') }}"></script>
  <script src="{{ asset('templates/web/vendor/glightbox/js/glightbox.min.js') }}"></script>
  <script src="{{ asset('templates/web/vendor/purecounter/purecounter_vanilla.js') }}"></script>
  <script src="{{ asset('templates/web/vendor/swiper/swiper-bundle.min.js') }}"></script>
  <script src="{{ asset('templates/web/vendor/php-email-form/validate.js') }}"></script>
